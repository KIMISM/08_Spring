...
//                '/security/admin' 경로는 ADMIN 권한이 있는 사용자만 접근 가능
        ...
        http.formLogin()// form 기반 로그인 활성화, 나머지 설정으 디폴트값 사용
                ...
                .loginProcessingUrl("/security/login") //로그인 페이지의 form에서 제출 시
...
//                remeber-me : 브라우저 종료 시 기억하게 하는 기능(따로 설정 필요)
                .deleteCookies("JSESSION-ID","remember-me") //사용하고 있던 쿠키 삭제
...
//                .password("$2a$10$bPw7udIYu6UscteES.8dzOSFZGarMxajkQGRaogSb5kSOS6skKDhK")
